        ...
        var d = {
                    ...
                    if (i) {
                        ...
                        if (!0 === e) {
                            !function e() {
                                ...
                                i = r,
                                u = s,
                                (n /= t / 2) < 1 ? u / 2 * n * n + i : -u / 2 * ((n -= 1) * (n - 2) - 1) + i);
                                o.scrollTop = c,
                                l < t ? requestAnimationFrame(e) : o.scrollTop = s
                            }()
                        } else
                            o.scrollTop = s
                    }
            ...
            scrollPageTo: function(e) {
                ...
                var i = n.scrollTop
                  ...
                  , r = +new Date;
                !function s() {
                    var a, u, l, c = +new Date - r, d = (a = c,
                    u = i,
                    l = o,
                    (a /= t / 2) < 1 ? l / 2 * a * a + u : -l / 2 * ((a -= 1) * (a - 2) - 1) + u);
                    n.scrollTop = d,
            ...
            setFlipped: function() {
                this[(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : c("reversed")) ? "_addClass" : "_removeClass"]("layout-menu-flipped")
            },
            update: function() {
