    ...
    return function() {
        ...
        function at(t, e, i) {
            ...
            if (t._sorted) {
                ...
                d && (n = q(Math.min(Z(r, a.axis, h).lo, i ? s : Z(e, l, a.getPixelForValue(h)).lo), 0, s - 1)),
                o = u ? q(Math.max(Z(r, a.axis, c, !0).hi + 1, i ? 0 : Z(e, l, a.getPixelForValue(c), !0).hi + 1), n, s) - n : s - n
            }
            return {
                start: n,
                count: o
        ...
        const xt = {
          ...
          , Mt = t=>(240 & t) >> 4 == (15 & t);
        function wt(t) {
            var e = (t=>Mt(t.r) && Mt(t.g) && Mt(t.b) && Mt(t.a))(t) ? yt : vt;
            return t ? "#" + e(t.r) + e(t.g) + e(t.b) + ((t,e)=>t < 255 ? e(t) : "")(t.a, e) : void 0
        }
        const kt = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
        function St(t, e, i) {
        ...
        const Ft = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
        const Vt = t=>t <= .0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - .055
          , Bt = t=>t <= .04045 ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4);
        function Wt(t, e, i) {
            if (t) {
                let s = Ot(t);
        ...
        function Ht(t) {
            return "r" === t.charAt(0) ? function(t) {
                ...
                if (e) {
                    ...
                    s = +e[3],
                    n = +e[5],
                    i = 255 & (e[2] ? gt(i) : ft(i, 0, 255)),
                    s = 255 & (e[4] ? gt(s) : ft(s, 0, 255)),
                    n = 255 & (e[6] ? gt(n) : ft(n, 0, 255)),
                    {
                        r: i,
                        g: s,
                        b: n,
        ...
        class $t {
            constructor(t) {
                ...
                let i;
                var s, n, o;
                "object" === e ? i = jt(t) : "string" === e && (o = (s = t).length,
                "#" === s[0] && (4 === o || 5 === o ? n = {
                    r: 255 & 17 * xt[s[1]],
                    g: 255 & 17 * xt[s[2]],
                    b: 255 & 17 * xt[s[3]],
            ...
            interpolate(t, e) {
                return t && (this._rgb = function(t, e, i) {
                    const s = Bt(mt(t.r))
                      ...
                      , o = Bt(mt(t.b));
                    return {
                        r: pt(Vt(s + i * (Bt(mt(e.r)) - s))),
                        g: pt(Vt(n + i * (Bt(mt(e.g)) - n))),
                        b: pt(Vt(o + i * (Bt(mt(e.b)) - o))),
                        a: t.a + i * (e.a - t.a)
                    }
                }(this._rgb, t._rgb, e)),
                this
        ...
        function qt(t) {
            return Ut(t) ? t : Yt(t).saturate(.5).darken(.1).hexString()
        }
        ...
        function Jt(t, e, i) {
            return "string" == typeof e ? b(Zt(t, e), i) : b(Zt(t, ""), e)
        }
        var Qt = new class {
            constructor(t) {
        ...
        function oe(t, e, i, s, n) {
            ...
            if (!(isNaN(f) || f <= 0)) {
                ...
                d) {
                default:
                    n ? t.ellipse(i, s, n / 2, f, 0, 0, D) : t.arc(i, s, f, 0, D),
                    t.closePath();
                    break;
                case "triangle":
                ...
                case "rectRounded":
                    ...
                    a = Math.cos(g + L) * l,
                    r = Math.sin(g + L) * l,
                    t.arc(i - a, s - r, h, g - P, g - T),
                    t.arc(i + r, s - a, h, g - T, g),
                    t.arc(i + a, s + r, h, g, g + T),
                    t.arc(i - r, s + a, h, g + T, g + P),
                    t.closePath();
                    break;
                case "rect":
                    if (!u) {
        ...
        function de(t, e, i, s, a, r={}) {
            ...
            c = 0; c < l.length; ++c)
                ...
                n(r.strokeWidth) || (t.lineWidth = r.strokeWidth),
        ...
        function fe(t, e) {
            ...
            t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, -T, P, !0),
            t.lineTo(i, s + o - a.bottomLeft),
            t.arc(i + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, P, T, !0),
        ...
        function Me(t, e) {
            ...
            s && !("" + s).match(pe) && (console.warn('Invalid font style specified: "' + s + '"'),
            s = "");
            const o = {
                family: h(t.family, e.family),
                lineHeight: me(h(t.lineHeight, e.lineHeight), i),
                size: i,
                style: s,
        ...
        function Se(t, e=[""], i=t, s, n=(()=>t[0])) {
            w(s) || (s = ze("_fallback", t));
            const o = {
            ...
            return new Proxy(o,{
                ...
                get(i, s) {
                    return Ae(i, s, (()=>function(t, e, i, s) {
                        let n;
                        for (const o of e)
                            if (n = ze(Oe(o, t), i),
                            w(n))
                                return Ce(t, n) ? Re(i, s, t, n) : n
                    }(s, e, t, i)))
                },
        ...
        function Pe(t, e, i, s) {
            const n = {
                ...
                _stack: new Set,
                _descriptors: De(t, s),
                setContext: e=>Pe(t, e, i, s),
                override: n=>Pe(t.override(n), e, i, s)
            };
            return new Proxy(n,{
                deleteProperty(e, i) {
                    return delete e[i],
                ...
                get(t, e, i) {
                    return Ae(t, e, (()=>function(t, e, i) {
                        const {_proxy: s, _context: n, _subProxy: r, _descriptors: l} = t;
                        let h = s[e];
                        k(h) && l.isScriptable(e) && (h = function(t, e, i, s) {
                            ...
                            e = e(o, a || s),
                            r.delete(t),
                            Ce(t, e) && (e = Re(n._scopes, n, t, e));
                            return e
                        }(e, h, t, i));
                        o(h) && h.length && (h = function(t, e, i, s) {
                            const {_proxy: n, _context: o, _subProxy: r, _descriptors: l} = i;
                            if (w(o.index) && s(t))
                                ...
                                for (const a of i) {
                                    const i = Re(s, n, t, a);
                                    e.push(Pe(i, o, r && r[t], l))
                                }
                            }
                            return e
                        }(e, h, t, l.isIndexable));
                        Ce(e, h) && (h = Pe(h, n, r && r[e], l));
                        return h
                    }(t, e, i)))
                },
        ...
        const Oe = (t,e)=>t ? t + M(e) : e
          , Ce = (t,e)=>a(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
        function Ae(t, e, i) {
        ...
        const Le = (t,e)=>!0 === t ? e : "string" == typeof t ? v(e, t) : void 0;
        function Ee(t, e, i, s, n) {
            for (const o of e) {
                const e = Le(i, o);
                if (e) {
                    t.add(e);
                    const o = Te(e._fallback, i, n);
                    if (w(o) && o !== i && o !== s)
                        return o
                } else if (!1 === e && w(s) && i !== s)
                    return null
        ...
        function Re(t, e, i, s) {
            const n = e._rootScopes
              , r = Te(e._fallback, i, s)
              , l = [...t, ...n]
              , h = new Set;
            h.add(s);
            let c = Ie(h, l, i, r || i, s);
            return null !== c && ((!w(r) || r === i || (c = Ie(h, l, r, c, s),
            null !== c)) && Se(Array.from(h), [""], n, r, (()=>function(t, e, i) {
        ...
        function He(t, e="x") {
            ...
            !function(t, e, i) {
                const s = t.length;
                let n, o, a, r, l, h = We(t, 0);
                for (let c = 0; c < s - 1; ++c)
                    l = h,
                    h = We(t, c + 1),
                    l && h && (V(e[c], 0, Be) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                    o = i[c + 1] / e[c],
        ...
        function Ye(t, e, i, s, n) {
            ...
            e.capBezierPoints && function(t, e) {
                ...
                s = t.length; i < s; ++i)
                    ...
                    r = i < s - 1 && ae(t[i + 1], e),
                    o && (n = t[i],
                    a && (n.cp1x = $e(n.cp1x, e.left, e.right),
                    n.cp1y = $e(n.cp1y, e.top, e.bottom)),
                    r && (n.cp2x = $e(n.cp2x, e.left, e.right),
                    n.cp2y = $e(n.cp2y, e.top, e.bottom)))
            }(t, i)
        }
        function Ue() {
        ...
        const Je = (t,e,i)=>(t > 0 || e > 0) && (!i || !i.shadowRoot);
        function Qe(t, e) {
            if ("native"in t)
                return t;
        ...
        function ei(t, e, i, s) {
            const n = Ke(t)
              , o = Ze(n, "margin")
              , a = qe(n.maxWidth, t, "clientWidth") || C
              , r = qe(n.maxHeight, t, "clientHeight") || C
              , l = function(t, e, i) {
                let s, n;
            ...
            h = ti(Math.min(h, a, l.maxWidth)),
            c = ti(Math.min(c, r, l.maxHeight)),
            h && !c && (c = ti(h / 2)),
            {
                width: h,
                height: c
        ...
        const ki = Object.keys(Qt.animation);
        Qt.describe("animation", {
            _fallback: !1,
            _indexable: !1,
        ...
        function Li(t, e) {
            ...
            for (let t = 0; t < d; ++t) {
                const i = e[t]
                  , {[l]: o, [h]: d} = i;
                u = (i._stacks || (i._stacks = {}))[h] = Ai(n, c, o),
                u[r] = d,
                u._top = Ti(u, a, !0, s.type),
                u._bottom = Ti(u, a, !1, s.type)
            }
        }
        function Ei(t, e) {
            const i = t.scales;
        ...
        class Fi {
            ...
            updateIndex(t) {
                this.index !== t && Ri(this._cachedMeta),
                this.index = t
            }
            linkScales() {
                const t = this.chart
                  ...
                  , n = e.xAxisID = h(i.xAxisID, Ei(t, "x"))
                  , o = e.yAxisID = h(i.yAxisID, Ei(t, "y"))
                  , a = e.rAxisID = h(i.rAxisID, Ei(t, "r"))
                  , r = e.indexAxis
            ...
            buildOrUpdateElements(t) {
                ...
                (s || n !== e._stacked) && Li(this, e._parsed)
            }
            configure() {
            ...
            updateRangeFromParsed(t, e, i, s) {
                ...
                s && a && (s.values = a,
                o = Oi(s, n, this._cachedMeta.index)),
            ...
            _resolveAnimations(t, e, i) {
                ...
                const l = new Si(s,r && r.animations);
            ...
            updateElement(t, e, i, s) {
                Ii(s) ? Object.assign(t, i) : this._resolveAnimations(e, s).update(t, i)
            }
            updateSharedOptions(t, e, i) {
                t && !Ii(e) && this._resolveAnimations(void 0, e).update(t, i)
            }
            _setStyle(t, e, i, s) {
                t.active = s;
        ...
        function Vi(t) {
            ...
            const l = ()=>{
                32767 !== o && -32768 !== o && (w(a) && (r = Math.min(r, Math.abs(o - a) || r)),
                a = o)
            }
            ;
            for (s = 0,
        ...
        function Hi(t, e, i, s) {
            var n, o, a;
            return s ? (a = i,
            t = $i(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = $i(t, e, i),
            t
        }
        function $i(t, e, i) {
            return "start" === t ? e : "end" === t ? i : t
        }
        function Yi(t, {inflateAmount: e}, i) {
            t.inflateAmount = "auto" === e ? 1 === i ? .33 : 0 : e
        }
        Fi.defaults = {},
        Fi.prototype.datasetElementType = null,
        Fi.prototype.dataElementType = null;
        class Ui extends Fi {
            parsePrimitiveData(t, e, i, s) {
                return Wi(t, e, i, s)
            }
            ...
            getLabelAndValue(t) {
                const e = this._cachedMeta
                  ...
                  , n = this.getParsed(t)
                  , o = n._custom
                  , a = Ni(o) ? "[" + o.start + ", " + o.end + "]" : "" + s.getLabelForValue(n[s.axis]);
                return {
                ...
                for (let f = e; f < e + i; f++) {
                    const e = this.getParsed(f)
                      ...
                      , m = {
                        horizontal: h,
                        base: i.base,
                        enableBorderRadius: !p || Ni(e._custom) || a === p._top || a === p._bottom,
                        x: h ? i.head : g.center,
                        y: h ? g.center : i.head,
            ...
            _calculateBarValuePixels(t) {
                const {_cachedMeta: {vScale: e, _stacked: i}, options: {base: s, minBarLength: o}} = this
                  , a = s || 0
                  , r = this.getParsed(t)
                  , l = r._custom
                  , h = Ni(l);
                ...
                if (e.grouped) {
                    const i = o ? this._getStackCount(t) : e.stackCount
                      , h = "flex" === s.barThickness ? function(t, e, i, s) {
                        ...
                        let a, r;
                        return n(o) ? (a = e.min * i.categoryPercentage,
                        r = i.barPercentage) : (a = o * s,
                        r = 1),
                        {
                            chunk: a / s,
                            ratio: r,
        ...
        class qi extends Fi {
            ...
            update(t) {
                ...
                const d = this._getRingWeight(this.index)
                  ...
                  , {ratioX: g, ratioY: p, offsetX: m, offsetY: b} = function(t, e, i) {
                    let s = 1
                      , n = 1
                      , o = 0
                      , a = 0;
            ...
            getLabelAndValue(t) {
                const e = this._cachedMeta
                  , i = this.chart
                  , s = i.data.labels || []
                  , n = hi(e._parsed[t], i.options.locale);
                return {
                    label: s[t] || "",
                    value: n
                }
        ...
        class Ki extends Fi {
            ...
            updateElements(t, e, i, s) {
                ...
                for (let g = e; g < e + i; ++g) {
                    ...
                    _.skip = isNaN(v) || isNaN(M) || y,
                    _.stop = g > 0 && Math.abs(i[u] - x[u]) > m,
                    p && (_.parsed = i,
                    _.raw = h.data[g]),
                    d && (_.options = c || this.resolveDataElementOptions(g, e.active ? "active" : s)),
                    b || this.updateElement(e, g, _, s),
                    x = i
                }
            }
            getMaxOverflow() {
        ...
        class Gi extends Fi {
            ...
            getLabelAndValue(t) {
                const e = this._cachedMeta
                  , i = this.chart
                  , s = i.data.labels || []
                  , n = hi(e._parsed[t].r, i.options.locale);
                return {
                    label: s[t] || "",
                    value: n
                }
        ...
        function is(t, e) {
            ...
            if (a > 0) {
                ...
                for (ss(e, h, c, n(s) ? 0 : r - s, r),
                t = 0,
                i = a - 1; t < i; t++)
                    ss(e, h, c, o[t], o[t + 1]);
                return ss(e, h, c, l, n(s) ? e.length : l + s),
                h
            }
            return ss(e, h, c),
            h
        ...
        Qt.route("scale.ticks", "color", "", "color"),
        Qt.route("scale.grid", "color", "", "borderColor"),
        Qt.route("scale.grid", "borderColor", "", "borderColor"),
        Qt.route("scale.title", "color", "", "color"),
        Qt.describe("scale", {
            _fallback: !1,
        ...
        class cs extends Qi {
            ...
            getUserBounds() {
                ...
                return t = l(t, Number.POSITIVE_INFINITY),
                e = l(e, Number.NEGATIVE_INFINITY),
                i = l(i, Number.POSITIVE_INFINITY),
                s = l(s, Number.NEGATIVE_INFINITY),
                {
                    min: l(t, i),
                    max: l(e, s),
                    minDefined: r(t),
            ...
            update(t, e, i) {
                ...
                o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = is(this, this.ticks),
                this._labelSizes = null,
                this.afterAutoSkip()),
            ...
            calculateLabelRotation() {
                ...
                a = this.maxHeight - rs(t.grid) - e.padding - ls(t.title, this.chart.options.font),
                r = Math.sqrt(c * c + d * d),
                l = N(Math.min(Math.asin(q((h.highest.height + 6) / o, -1, 1)), Math.asin(q(a / r, -1, 1)) - Math.asin(q(d / r, -1, 1)))),
            ...
            _computeLabelSizes(t, e) {
                const {ctx: i, _longestTextCache: s} = this
                  , a = []
                  , r = [];
                let l, h, c, d, f, g, p, m, b, x, _, y = 0, v = 0;
                for (l = 0; l < e; ++l) {
                    if (d = t[l].label,
                    ...
                    n(d) || o(d)) {
                        if (o(d))
                            ...
                            c = d.length; h < c; ++h)
                                _ = d[h],
                                n(_) || o(_) || (b = te(i, p.data, p.gc, b, _),
                                x += m)
                    } else
                        b = te(i, p.data, p.gc, b, d),
                        x = m;
                    a.push(b),
                    r.push(x),
                    y = Math.max(b, y),
            ...
            getPixelForDecimal(t) {
                ...
                return q(this._alignToPixels ? ie(this.chart, e, 0) : e, -32768, 32767)
            }
            ...
            getContext(t) {
                ...
                return this.$context || (this.$context = ke(this.chart.getContext(), {
                    scale: this,
                    type: "scale"
                }))
            }
            ...
            _computeLabelItems(t) {
                const e = this.axis
                  ...
                  , r = this.isHorizontal()
                  , l = this.ticks
                  , {align: h, crossAlign: c, padding: d, mirror: u} = n
                  , f = rs(i.grid)
                  , g = f + d
                  , p = u ? -d : g
                ...
                _ = l.length; x < _; ++x) {
                    ...
                    C = "top" === s ? "near" === c || 0 !== m ? -O * D + D / 2 : "center" === c ? -T.highest.height / 2 - e * D + D : -T.highest.height + D / 2 : "near" === c || 0 !== m ? D / 2 : "center" === c ? T.highest.height / 2 - e * D : T.highest.height - O * D,
                    u && (C *= -1)) : (w = S,
                    C = (1 - O) * D / 2),
                    t.showLabelBackdrop) {
            ...
            drawBorder() {
                ...
                const o = i.setContext(this.getContext(0)).lineWidth
                  , a = this._borderValue;
                let r, l, h, c;
                this.isHorizontal() ? (r = ie(t, this.left, n) - n / 2,
                l = ie(t, this.right, o) + o / 2,
                h = c = a) : (h = ie(t, this.top, n) - n / 2,
                c = ie(t, this.bottom, o) + o / 2,
                r = l = a),
                e.save(),
            ...
            drawTitle() {
                ...
                "bottom" === e || "center" === e || a(e) ? (h += r.bottom,
                o(i.text) && (h += n.lineHeight * (i.text.length - 1))) : h += r.top;
                const {titleX: c, titleY: d, maxWidth: u, rotation: f} = function(t, e, i, s) {
                    const {top: n, left: o, bottom: r, right: l, chart: h} = t
                    ...
                    if (t.isHorizontal()) {
                        ...
                        a(i)) {
                            ...
                            g = "center" === i ? (c.bottom + c.top) / 2 + m - e : ns(t, i, e);
                        u = l - o
                    } else {
                        if (a(i)) {
                            const t = Object.keys(i)[0]
                            ...
                            f = "center" === i ? (c.left + c.right) / 2 - b + e : ns(t, i, e);
                        g = ot(s, r, n),
                        p = "left" === i ? -T : T
                    }
                    return {
        ...
        class ds {
            ...
            register(t) {
                ...
                return n in s || (s[n] = t,
                function(t, e, i) {
                    const s = b(Object.create(null), [i ? Qt.get(i) : {}, Qt.get(e), t.defaults]);
                    Qt.set(e, s),
            ...
            unregister(t) {
                const e = this.items
                  ...
                  , s = this.scope;
                i in e && delete e[i],
                s && i in Qt[s] && (delete Qt[s][i],
                this.override && delete Kt[i])
            }
        }
        var us = new class {
            constructor() {
                this.controllers = new ds(Fi,"datasets",!0),
                this.elements = new ds(Qi,"elements"),
                this.plugins = new ds(Object,"plugins"),
                this.scales = new ds(cs,"scales"),
        ...
        class fs extends Fi {
            ...
            updateElements(t, e, i, s) {
                ...
                for (let c = e; c < e + i; ++c) {
                    ...
                    m && (p.parsed = i,
                    p.raw = h.data[c]),
                    u && (p.options = d || this.resolveDataElementOptions(c, e.active ? "active" : s)),
                    x || this.updateElement(e, c, p, s),
                    _ = i
                }
        ...
        function ys(t, e, i, s, n) {
            ...
            return _s(t, i, e, (function(i, a, r) {
                (n || ae(i, t.chartArea, 0)) && i.inRange(e.x, e.y, s) && o.push({
                    element: i,
                    datasetIndex: a,
                    index: r
                })
        ...
        var ks = {
            ...
            modes: {
                ...
                point(t, e, i, s) {
                    return ys(t, Qe(e, t), i.axis || "xy", s, i.includeInvisible || !1)
                },
                nearest(t, e, i, s) {
                    const n = Qe(e, t)
                      , o = i.axis || "xy"
                ...
                x(t, e, i, s) {
                    return ws(t, Qe(e, t), "x", i.intersect, s)
                },
                y(t, e, i, s) {
                    return ws(t, Qe(e, t), "y", i.intersect, s)
                }
            }
        };
        ...
        function Ls(t, e, i, s) {
            ...
            o.getPadding && Ts(r, o.getPadding());
            const l = Math.max(0, e.outerWidth - As(r, t, "left", "right"))
              , h = Math.max(0, e.outerHeight - As(r, t, "top", "bottom"))
              , c = l !== t.w
              , d = h !== t.h;
            return t.w = l,
            t.h = h,
        ...
        var Fs = {
            ...
            update(t, e, i, s) {
                ...
                const n = ve(t.options.layout.padding)
                  ...
                  , r = function(t) {
                    const e = function(t) {
                      ...
                      , i = Os(e.filter((t=>t.box.fullSize)), !0)
                      , s = Os(Ps(e, "left"), !0)
                      , n = Os(Ps(e, "right"))
                      , o = Os(Ps(e, "top"), !0)
                      , a = Os(Ps(e, "bottom"))
                ...
                zs(r.leftAndTop, g, d, p),
                g.x += g.w,
                g.y += g.h,
                zs(r.rightAndBottom, g, d, p),
                t.chartArea = {
                    left: g.left,
                    top: g.top,
                    right: g.left + g.w,
        ...
        function Us(t, e, i) {
            const s = t.canvas
              , n = new MutationObserver((t=>{
                let e = !1;
                for (const i of t)
                    e = e || Ys(i.addedNodes, s),
                    e = e && !Ys(i.removedNodes, s);
                e && i()
            }
            ));
        ...
        function Zs(t, e, i) {
            ...
            return a.observe(n),
            function(t, e) {
                qs.size || window.addEventListener("resize", Gs),
                qs.set(t, e)
            }(t, o),
            a
        }
        function Js(t, e, i) {
            ...
            "resize" === e && function(t) {
                qs.delete(t),
                qs.size || window.removeEventListener("resize", Gs)
            }(t)
        }
        function Qs(t, e, i) {
            const s = t.canvas
        ...
        class en {
            ...
            invalidate() {
                n(this._cache) || (this._oldCache = this._cache,
                this._cache = void 0)
            }
            _descriptors(t) {
                if (this._cache)
        ...
        class fn {
            ...
            datasetAnimationScopeKeys(t, e) {
                return dn(`${t}.transition.${e}`, (()=>[[`datasets.${t}.transitions.${e}`, `transitions.${e}`], [`datasets.${t}`, ""]]))
            }
            ...
            getOptionScopes(t, e, i) {
                ...
                e.forEach((e=>{
                    t && (r.add(t),
                    e.forEach((e=>un(r, t, e)))),
                    e.forEach((t=>un(r, s, t))),
                    e.forEach((t=>un(r, Kt[n] || {}, t))),
            ...
            resolveNamedOptions(t, e, i, s=[""]) {
                const n = {
                  ...
                  , {resolver: a, subPrefixes: r} = gn(this._resolverCache, t, s);
                let l = a;
                if (function(t, e) {
                    const {isScriptable: i, isIndexable: s} = De(t);
                    for (const n of e) {
                        const e = i(n)
                          , a = s(n)
                          , r = (a || e) && t[n];
                    ...
                    n.$shared = !1;
                    l = Pe(a, i = k(i) ? i() : i, this.createResolver(t, i, r))
                }
                for (const t of e)
                    n[t] = l[t];
                return n
        ...
        const pn = t=>a(t) && Object.getOwnPropertyNames(t).reduce(((e,i)=>e || k(t[i])), !1);
        ...
        class Sn {
            constructor(t, e) {
                ...
                this.platform = new (i.platform || function(t) {
                    return !Ue() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? Bs : tn
                }(n)),
                ...
                this._dataChanges = [],
                Mn[this.id] = this,
                r && l ? (yi.listen(this, "complete", _n),
                yi.listen(this, "progress", yn),
                this._initialize(),
            ...
            clear() {
                return se(this.canvas, this.ctx),
                this
            }
            stop() {
                return yi.stop(this),
            ...
            buildOrUpdateScales() {
                ...
                u(n, (e=>{
                    const n = e.options
                      ...
                      , a = an(o, n)
                      , r = h(n.type, e.dtype);
                    void 0 !== n.position && bn(n.position, a) === bn(e.dposition) || (n.position = e.dposition),
                    s[o] = !0;
                    let l = null;
                ...
                s = e.length; i < s; i++) {
                    ...
                    n.controller)
                        ...
                        const e = us.getController(o)
                          , {datasetElementType: s, dataElementType: a} = Qt.datasets[o];
        ...
        const Pn = ()=>u(Sn.instances, (t=>t._plugins.invalidate()))
          , Dn = !0;
        function On(t, e, i) {
            ...
            t.arc(o, a, r, s - h, i + h),
            l > n ? (h = n / l,
            t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + T, s - T),
            t.closePath(),
            t.clip()
        }
        function Cn(t, e, i, s) {
            const n = xe(t.options.borderRadius, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
            const o = (i - e) / 2
              , a = Math.min(o, s * e / 2)
              , r = t=>{
        ...
        function Tn(t, e, i, s, n, o) {
            ...
            const p = (g - Math.max(.001, g * d - i / P) / d) / 2
              , m = l + p + f
              , b = n - p - f
              , {outerStart: x, outerEnd: _, innerStart: y, innerEnd: v} = Cn(e, u, d, b - m)
              , M = d - x
              , w = d - _
              , k = m + x / M
              , S = b - _ / w
        ...
        class En extends Qi {
            ...
            inRange(t, e, i) {
                const s = this.getProps(["x", "y"], i)
                  , {angle: n, distance: o} = H(s, {
                    x: t,
                    y: e
                })
                  , {startAngle: a, endAngle: r, innerRadius: l, outerRadius: c, circumference: d} = this.getProps(["startAngle", "endAngle", "innerRadius", "outerRadius", "circumference"], i)
            ...
            draw(t) {
                ...
                this.fullCircles = i > D ? Math.floor(i / D) : 0,
        ...
        function Fn(t, e, i, s) {
            const {points: n, options: o} = e
              ...
              , c = function(t) {
                return t.stepped ? he : t.tension || "monotone" === t.cubicInterpolationMode ? ce : In
            }(o);
        ...
        function Bn(t) {
            ...
            return !(t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped || i) ? Vn : Fn
        }
        En.id = "arc",
        En.defaults = {
            borderAlign: "center",
        ...
        function Nn(t, e, i, s) {
            Wn && !e.options.segment ? function(t, e, i, s) {
                let n = e._path;
        ...
        class $n extends Qi {
            ...
            draw(t, e) {
                const i = this.options;
                this.skip || i.radius < .1 || !ae(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor,
            ...
            const e = Yn(t)
              ...
              , n = function(t, e, i) {
                const s = t.options.borderWidth
                  ...
                  , o = _e(s);
                return {
                    t: Un(n.top, o.top, 0, i),
                    r: Un(n.right, o.right, 0, e),
                    b: Un(n.bottom, o.bottom, 0, i),
                    l: Un(n.left, o.left, 0, e)
                }
            }(t, i / 2, s / 2)
              , o = function(t, e, i) {
                const {enableBorderRadius: s} = t.getProps(["enableBorderRadius"])
                  ...
                  , h = s || a(n);
                return {
                    topLeft: Un(!h || l.top || l.left, o.topLeft, 0, r),
                    topRight: Un(!h || l.top || l.right, o.topRight, 0, r),
                    bottomLeft: Un(!h || l.bottom || l.left, o.bottomLeft, 0, r),
                    bottomRight: Un(!h || l.bottom || l.right, o.bottomRight, 0, r)
                }
            }(t, i / 2, s / 2);
            return {
                outer: {
        ...
        class Zn extends Qi {
            ...
            draw(t) {
                const {inflateAmount: e, options: {borderColor: i, backgroundColor: s}} = this
                  , {inner: n, outer: o} = Xn(this)
                  , a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? fe : Kn;
                var r;
                t.save(),
            ...
            beforeElementsUpdate: (t,e,i)=>{
                ...
                t.data.datasets.forEach(((e,o)=>{
                    ...
                    let {start: d, count: u} = function(t, e) {
                        ...
                        return l && (n = q(Z(e, o.axis, a).lo, 0, i - 1)),
                        s = h ? q(Z(e, o.axis, r).hi + 1, n, i) - n : i - n,
                        {
                            start: n,
                            count: s
                        }
        ...
        function ho(t, e, i) {
            ...
            for (let n = 0; n < i.length; n++) {
                const o = i[n]
                  , {first: a, last: r, point: l} = co(o, e, "x");
                if (!(!l || a && r))
                    if (a)
                        s.unshift(l);
                    else if (t.push(l),
        ...
        function fo(t) {
                ...
                if (e.getPointPositionForValue)
                    return function(t) {
                        const {scale: e, fill: i} = t
                          ...
                          , r = function(t, e, i) {
                            let s;
                            return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : a(t) ? t.value : e.getBaseValue(),
                            s
                        }(i, e, o)
                          , l = [];
                        if (s.grid.circular) {
            ...
            return n instanceof uo ? n : oo(n, s)
        }
        function go(t, e, i) {
            const s = fo(e)
            ...
            const {line: i, target: s, property: n, color: o, scale: a} = e
              , r = function(t, e, i) {
                ...
                for (const t of s) {
                    ...
                    const h = mi(e, l);
                    for (const e of h) {
                        const s = io(i, o[e.start], o[e.end], e.loop)
                          , r = pi(t, n, s);
                        for (const t of r)
                            a.push({
                                source: t,
                                target: e,
                                start: {
                                    [i]: no(l, s, "start", Math.max)
                                },
                                end: {
                                    [i]: no(l, s, "end", Math.min)
                                }
                            })
                    }
                }
        ...
        var _o = {
            ...
            afterDatasetsUpdate(t, e, i) {
                ...
                for (a = 0; a < s; ++a)
                    l = n[a],
                    l && !1 !== l.fill && (l.fill = ro(n, a, i.propagate))
            },
            beforeDraw(t, e, i) {
            ...
            beforeDatasetsDraw(t, e, i) {
                ...
                for (let e = s.length - 1; e >= 0; --e) {
                    const i = s[e].$filler;
                    ao(i) && go(t.ctx, i, t.chartArea)
                }
            },
            beforeDatasetDraw(t, e, i) {
                const s = e.meta.$filler;
                ao(s) && "beforeDatasetDraw" === i.drawTime && go(t.ctx, s, t.chartArea)
            },
            defaults: {
                propagate: !0,
        ...
        class vo extends Qi {
            ...
            fit() {
                ...
                const i = t.labels
                  ...
                  , {boxWidth: a, itemHeight: r} = yo(i, n);
                let l, h;
                e.font = s.string,
            ...
            _draw() {
                ...
                s.lineWidth = .5,
                s.font = l.string;
                const {boxWidth: p, boxHeight: m, itemHeight: b} = yo(o, u)
                  , x = this.isHorizontal()
                ...
                this.legendItems.forEach(((v,M)=>{
                    ...
                    x ? M > 0 && P + S + d > this.right && (D = g.y += y,
                    g.line++,
                    P = g.x = ot(n, this.left + d, this.right - i[g.line])) : M > 0 && D + y > this.bottom && (P = g.x = P + e[g.line].width + d,
                    g.line++,
                    D = g.y = ot(n, this.top + _ + d, this.bottom - e[g.line].height));
                    !function(t, e, i) {
                        if (isNaN(p) || p <= 0 || isNaN(m) || m < 0)
                            return;
                        s.save();
                        const n = h(i.lineWidth, 1);
                        if (s.fillStyle = h(i.fillStyle, a),
                        ...
                        o.usePointStyle) {
                            const a = {
                              ...
                              , l = r.xPlus(t, p / 2);
                            oe(s, a, l, e + f, o.pointStyleWidth && p)
                        } else {
                            const o = e + Math.max((u - m) / 2, 0)
                              , a = r.leftForLtr(t, p)
                              , l = ye(i.borderRadius);
                            s.beginPath(),
                            Object.values(l).some((t=>0 !== t)) ? fe(s, {
                                x: a,
                                y: o,
                                w: p,
                                h: m,
                    ...
                    P = ((t,e,i,s)=>t === (s ? "left" : "right") ? i : "center" === t ? (e + i) / 2 : e)(k, P + p + f, x ? P + S : this.right, t.rtl),
                    function(t, e, i) {
                        de(s, i.text, t, e + b / 2, l, {
            ...
            _getLegendItemAt(t, e) {
                ...
                if (K(t, this.left, this.right) && K(e, this.top, this.bottom))
                    ...
                    i = 0; i < n.length; ++i)
                        if (s = n[i],
                        K(t, s.left, s.left + s.width) && K(e, s.top, s.top + s.height))
        ...
        class wo extends Qi {
            ...
            update(t, e) {
                ...
                const n = s * Me(i.font).lineHeight + this._padding.height;
            ...
            _drawArgs(t) {
                const {top: e, left: i, bottom: s, right: n, options: o} = this
                  , a = o.align;
                let r, l, h, c = 0;
                return this.isHorizontal() ? (l = ot(a, i, n),
                h = e + t,
        ...
        function Eo(t, e, i) {
            ...
            return {
                xAlign: i.xAlign || e.xAlign || Lo(t, e, i, s),
                yAlign: s
            }
        }
        function Ro(t, e, i, s) {
            const {caretSize: n, caretPadding: o, cornerRadius: a} = t
              , {xAlign: r, yAlign: l} = i
              , h = n + o
              , {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = ye(a);
            let g = function(t, e) {
                let {x: i, width: s} = t;
        ...
        class Vo extends Qi {
            ...
            getBody(t, e) {
                ...
                return u(t, (t=>{
                    const e = {
                      ...
                      , n = Fo(i, t);
                    Oo(e.before, Co(n.beforeLabel.call(this, t))),
                    Oo(e.lines, n.label.call(this, t)),
                    Oo(e.after, Co(n.afterLabel.call(this, t))),
                    s.push(e)
                }
                )),
                s
            ...
            getCaretPosition(t, e, i) {
                const {xAlign: s, yAlign: n} = this
                  ...
                  , {topLeft: r, topRight: l, bottomLeft: h, bottomRight: c} = ye(a)
                  , {x: d, y: u} = t
                  , {width: f, height: g} = e;
                let p, m, b, x, _, y;
            ...
            drawTitle(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Io(this, i.titleAlign, i),
            ...
            _drawColorBox(t, e, i, s, n) {
                ...
                if (n.usePointStyle) {
                    ...
                    t.lineWidth = a(o.borderWidth) ? Math.max(...Object.values(o.borderWidth)) : o.borderWidth || 1,
                    t.strokeStyle = o.borderColor,
            ...
            drawFooter(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Io(this, i.footerAlign, i),
            ...
            drawBackground(t, e, i, s) {
                const {xAlign: n, yAlign: o} = this
                  , {x: a, y: r} = t
                  , {width: l, height: h} = i
                  , {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = ye(s.cornerRadius);
        ...
        class jo extends cs {
            ...
            parse(t, e) {
                ...
                return ((t,e)=>null === t ? null : q(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : No(i, t, h(e, t), this._addedLabels), i.length - 1)
            }
            determineDataLimits() {
        ...
        function Ho(t, e) {
            const i = []
              , {bounds: s, step: o, min: a, max: r, precision: l, count: h, maxTicks: c, maxDigits: d, includeBounds: u} = t
              , f = o || 1
              , g = c - 1
              , {min: p, max: m} = e
              , b = !n(a)
            ...
            n(l) || (v = Math.pow(10, l),
            S = Math.ceil(S * v) / v),
            "ticks" === s ? (M = Math.floor(p / S) * S,
            w = Math.ceil(m / S) * S) : (M = p,
            w = m),
            b && x && o && function(t, e) {
                const i = Math.round(t);
                return i - e <= t && i + e >= t
            }((r - a) / o, S / 1e3) ? (k = Math.round(Math.min((r - a) / S, c)),
            S = (r - a) / k,
            M = a,
            w = r) : _ ? (M = b ? a : M,
            w = x ? r : w,
            ...
            M < a && D++,
            V(Math.round((M + D * S) * v) / v, a, $o(a, y, t)) && D++) : M < a && D++); D < k; ++D)
                i.push({
                    value: Math.round((M + D * S) * v) / v
                });
            return x && u && w !== r ? i.length && V(i[i.length - 1].value, r, $o(r, y, t)) ? i[i.length - 1].value = r : i.push({
                value: r
            }) : x && w !== r || i.push({
                value: w
            }),
        ...
        class Yo extends cs {
            ...
            buildTicks() {
                ...
                return "ticks" === t.bounds && B(s, this, "value"),
                t.reverse ? (s.reverse(),
                this.start = this.max,
        ...
        class qo extends cs {
            ...
            parse(t, e) {
                ...
                if (0 !== i)
                    return r(i) && i > 0 ? i : null;
                this._zero = !0
            }
            determineDataLimits() {
                const {min: t, max: e} = this.getMinMax(!0);
                this.min = r(t) ? Math.max(0, t) : null,
                this.max = r(e) ? Math.max(0, e) : null,
            ...
            buildTicks() {
                const t = this.options
                  , e = function(t, e) {
                    ...
                    do {
                        ...
                        ++a,
                        h = a >= 0 ? 1 : h),
                        o = Math.round(r * Math.pow(10, a) * h) / h
                    } while (a < i || a === i && r < s);
                    const c = l(t.max, o);
                    return n.push({
                        value: c,
                ...
                return "ticks" === t.bounds && B(e, this, "value"),
                t.reverse ? (e.reverse(),
                this.start = this.max,
                this.end = this.min) : (this.start = this.min,
                this.end = this.max),
            ...
            getLabelForValue(t) {
                return void 0 === t ? "0" : hi(t, this.chart.options.locale, this.options.ticks.format)
            }
            configure() {
                const t = this.min;
                super.configure(),
            ...
            getPixelForValue(t) {
                ...
                null === t || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (R(t) - this._startValue) / this._valueRange)
            }
            getValueForPixel(t) {
        ...
        function Ko(t) {
            ...
            if (e.display && t.display) {
                ...
                return h(e.font && e.font.size, Qt.font.size) + t.height
            }
            return 0
        }
        ...
        function Zo(t) {
            ...
            for (let u = 0; u < a; u++) {
                ...
                const m = U(t.getIndexAngle(u) + l)
                  , b = Math.round(N(m));
                Jo(i, e, m, Go(b, f.x, p.w, 0, 180), Go(b, f.y, p.h, 90, 270))
            }
            var h, c, d;
        ...
        function ia(t, e, i, s) {
            const {ctx: n} = t;
            if (i)
                n.arc(t.xCenter, t.yCenter, e, 0, D);
            else {
        ...
        qo.defaults = {
            ticks: {
                callback: es.formatters.logarithmic,
                major: {
                    enabled: !0
                }
            }
        ...
        class sa extends Yo {
            ...
            setDimensions() {
                const t = this._padding = ve(Ko(this.options) / 2)
            ...
            determineDataLimits() {
                ...
                this.min = r(t) && !isNaN(t) ? t : 0,
                this.max = r(e) && !isNaN(e) ? e : 0,
                this.handleTickRangeOptions()
            }
            computeTickLimit() {
            ...
            drawBackground() {
                ...
                if (t) {
                    ...
                    i.save(),
                    i.beginPath(),
                    ia(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
                    i.closePath(),
                    i.fillStyle = t,
                    i.fill(),
                    i.restore()
                ...
                if (e.pointLabels.display && function(t, e) {
                    ...
                    for (let o = e - 1; o >= 0; o--) {
                        const e = s.setContext(t.getPointLabelContext(o))
                          ...
                          , {backdropColor: g} = e;
                        if (!n(g)) {
                            const t = ye(e.borderRadius)
                              , s = ve(e.backdropPadding);
                            i.fillStyle = g;
                            const n = c - s.left
                              , o = d - s.top
                              , a = u - c + s.width
                        ...
                        de(i, t._pointLabels[o], r, l + a.lineHeight / 2, a, {
                            color: e.color,
                            textAlign: h,
                            textBaseline: "middle"
                        })
        ...
        function ra(t, e) {
            if (n(e))
                return null;
            const i = t._adapter
              , {parser: s, round: o, isoWeekday: a} = t._parseOpts;
            let l = e;
            return "function" == typeof s && (l = s(l)),
            r(l) || (l = "string" == typeof s ? i.parse(l, s) : i.parse(l)),
            null === l ? null : (o && (l = "week" !== o || !F(a) && !0 !== a ? i.startOf(l, o) : i.startOf(l, "isoWeek", a)),
            +l)
        }
        function la(t, e, i, s) {
            const n = oa.length;
        ...
        class da extends cs {
            ...
            determineDataLimits() {
                ...
                s = r(s) && !isNaN(s) ? s : +e.startOf(Date.now(), i),
                n = r(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1,
            ...
            _generate() {
                ...
                u++)
                    ha(c, d, g);
                return d !== i && "ticks" !== s.bounds && 1 !== u || ha(c, d, g),
        ...
        function ua(t, e, i) {
            ...
            i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = Z(t, "pos", e)),
            ({pos: s, time: o} = t[r]),
            ({pos: n, time: a} = t[l])) : (e >= t[r].time && e <= t[l].time && ({lo: r, hi: l} = Z(t, "time", e)),
            ({time: s, pos: o} = t[r]),
            ({time: n, pos: a} = t[l]));
            const h = n - s;
        ...
        const ga = [gs, Jn, Wo, Object.freeze({
            __proto__: null,
            CategoryScale: jo,
            LinearScale: Uo,
            LogarithmicScale: qo,
